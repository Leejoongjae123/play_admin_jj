...
> = {
  '2': {
    ...
    description:
      '한국적 정서가 담긴 독특한 공포 소설을 쓰는 작가. 일상 속 숨어있는 공포와 미스터리를 탁월하게 표현한다. 대표작 「밤이 깊어갈 때」.한국적 정서가 담긴 독특한 공포 소설을 쓰는 작가. 일상 속 숨어있는 공포와 미스터리를 탁월하게 표현한다. 대표작 「밤이 깊어갈 때」.한국적 정서가 담긴 독특한 공포 소설을 쓰는 작가. 일상 속 숨어있는 공포와 미스터리를 탁월하게 표현한다. 대표작 「밤이 깊어갈 때」.한국적 정서가 담긴 독특한 공포 소설을 쓰는 작가. 일상 속 숨어있는 공포와 미스터리를 탁월하게 표현한다. 대표작 「밤이 깊어갈 때」.',
    viewCount: 1450,
    bookmarkCount: 102,
    isVisible: true,
