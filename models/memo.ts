...
export const DummyMemos: Memo[] = [
  ...
  },
  {
    ...
    content:
      '로맨스 장르지만 진부하지 않고 감성적이었습니다. 편지를 통한 소통이라는 소재가 현대적으로 잘 해석된 것 같아요. 이은지 작가의 섬세한 감정 묘사가 돋보였습니다.로맨스 장르지만 진부하지 않고 감성적이었습니다. 편지를 통한 소통이라는 소재가 현대적으로 잘 해석된 것 같아요. 이은지 작가의 섬세한 감정 묘사가 돋보였습니다.로맨스 장르지만 진부하지 않고 감성적이었습니다. 편지를 통한 소통이라는 소재가 현대적으로 잘 해석된 것 같아요. 이은지 작가의 섬세한 감정 묘사가 돋보였습니다.로맨스 장르지만 진부하지 않고 감성적이었습니다. 편지를 통한',
    likeCount: 12,
    commentCount: 5,
    isLiked: true,
