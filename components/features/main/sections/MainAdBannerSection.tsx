...
export default function MainAdBannerSection() {
  return (
    <section className="relative flex w-full flex-col items-end bg-[#F8F1EA] xl:pb-[177px]">
      <div className="relative flex w-full flex-col gap-3 bg-gradient-to-b from-[#FAF6F1] to-[#FFFFFF] px-[8vw] pb-[120px] pt-20 xl:flex-row xl:items-center">
      ...
      <div className="relative -top-[100px] flex w-full flex-col gap-6 px-[8vw] lg:-top-[72px] lg:gap-20">
        {banners.map((banner) => (
