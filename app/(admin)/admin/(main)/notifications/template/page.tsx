...
export default function AdminNotificationTemplatesPage() {
  ...
  const templates: TemplateData[] = Array.from({ length: 100 }, (_, index) => {
  ...
  // 유형 옵션
  const typeOptions = ['전체', '프로그램', '희곡', '작가', '공지', '커뮤니티', '기타'];
        ...
        <div className="flex w-full flex-col items-start gap-[18px] rounded-lg bg-[#FAF8F6] p-8">
          <div className="flex w-full items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="default"
                className="flex h-[43px] h-auto w-[120px] items-center justify-center gap-2 rounded bg-primary px-0 py-3 font-pretendard text-base font-semibold text-white"
              >
              ...
              <Button
                variant="outline"
                className="flex h-[43px] h-auto w-[120px] items-center justify-center gap-2 rounded border border-primary bg-white px-0 py-3 font-pretendard text-base font-semibold text-primary"
              >
          ...
          <div className="flex w-full flex-col items-end gap-4">
            <div className="flex w-full items-center justify-between">
              <div className="font-pretendard text-xl font-medium leading-6 tracking-[-0.4px]">
                ...
                <span className="text-primary">{templates.length.toLocaleString()}</span>
