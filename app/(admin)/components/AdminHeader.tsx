      ...
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <div className="profile-wrapper flex cursor-pointer items-center gap-2">
            <Image src="/images_jj/profile.png" alt="search" width={24} height={24} />
            <span className="text-[16px] text-gray-3">홍길동님</span>
          </div>
        </PopoverTrigger>
          ...
          <div className="flex flex-col items-end gap-2 p-4 pb-5">
            ...
            <div className="flex w-[143px] flex-col items-center gap-[19px]">
              ...
              <div className="flex w-full flex-col">
                {/* 비밀번호 변경 */}
                <button className="flex w-full items-end gap-2 p-[6px_8px] transition-colors hover:bg-gray-50">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
                ...
                {/* 로그아웃 */}
                <button className="flex w-full items-center gap-2 p-[6px_8px] transition-colors hover:bg-gray-50">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
